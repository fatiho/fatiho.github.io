...
import part from '../particles.jpg'
...
const Projects = () => {
    ...
    <Card.Img className="cardimages-parts" variant="top" src={part} />
      </div>
      <Card.Text className="exp-body">
  ...
  <Card>
    ...
    <Card.Body>
      ...
      <Card.Title><strong>Musallah</strong></Card.Title>
      <div className="card-row">
  ...
  <Card>
    ...
    <Card.Body>
      <Card.Title><strong>Spotify - the command line edition</strong></Card.Title>
      <div className="card-row">
...
<Card>
    ...
    <Card.Body>
      <Card.Title><strong>Traveling Doctor App</strong></Card.Title>
      <div className="card-row">
  ...
  <Card>
    ...
    <Card.Body>
      <Card.Title><strong>Ergonomic Pillow</strong></Card.Title>
      <div className="card-row">
...
<Card>
    ...
    <Card.Body>
      <Card.Title><strong>Datathon Project</strong></Card.Title>
      <div className="card-row">
...
In this analysis, we used statistical learning (LASSO and Logistic regression, KNN and Random forest) to predict a customer’s product category of interest (1 in 40) with 20% accuracy and potential time of purchase with 40% accuracy 

Our analysis would allow for a leading retail chain under Baring P.E. to advertise with 8% success rate, 7.54 points higher than average
      </Card.Text>

      <Card.Text>Analyzed and cleaned dataset primarily using Python and R.</Card.Text>
